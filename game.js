document.addEventListener("DOMContentLoaded", () => {
  ...
  const questions = {
    "Назад в будущее": {
      ...
      400: {
        question: {
          text: "История знакомства Ярика и Саши хорошо известна от них самих: кастинг в «Онегина», распевки в туалете, воротник, Кузьмин. Известна и ария, с которой они оба выступили на кастинге. По признанию Саши на одном шоу, он поёт эту арию именно в ТАКОЙ версии.\n​Что это за версия?"},
        answer: {

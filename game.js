document.addEventListener("DOMContentLoaded", () => {
  ...
  const questions = {
    "Назад в будущее": {
      ...
      400: {
        question: {
          text: "Вряд ли кто-то не знает историю знакомства Ярика и Саши: кастинг «Демон Онегина», распевки в туалете, воротник, Кузьмин. Полагаю, что все помнят и арию, с которой они оба выступили на кастинге. Вот про неё и будет следующий вопрос: по признанию Саши на одном шоу, он поёт эту арию именно в ТАКОЙ версии.\n​Что же за версия?​"
        },
        answer: {
      ...
      500: {
        question: {
          text: "Эти персонажи Саши и Ярика расходятся почти во всём: ​по периоду, когда ребята их играют, по настроению мюзиклов, ​в которых происходит действо, по вайбу. ​И всё же их роднит ремесло, которым они зарабатывают ​на жизнь (по крайней мере пытаются).\n​Что это за ремесло?​"
        },
        answer: {
